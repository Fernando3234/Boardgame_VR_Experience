...
public class PullMeasurer : XRBaseInteractable
{
    ...
    public override bool IsSelectableBy(XRBaseInteractor interactorObject)
    {
        // Only let direct interactors pull the string
        return base.IsSelectableBy(interactorObject) && IsDirectInteractor(interactorObject);
    }

    private bool IsDirectInteractor(XRBaseInteractor interactorObject)
    {
        return interactorObject is XRDirectInteractor;
    }
